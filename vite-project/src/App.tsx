              ...
              <div className="absolute inset-0 bg-white">
                <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
                  <svg viewBox="0 0 300 400" className="w-full h-full">
                    ...
                    <path 
                      d="M100,50 C100,50 95,80 90,100 L50,120 L50,350 L250,350 L250,120 L210,100 C205,80 200,50 200,50 C200,50 180,60 150,60 C120,60 100,50 100,50 Z" 
                      fill="url(#shirt-gradient)" 
                      stroke="#cccccc" 
                      strokeWidth="2"
                    />
                    <path 
                      d="M100,50 C100,50 120,70 150,70 C180,70 200,50 200,50" 
                      fill="none" 
                      stroke="#cccccc" 
                      strokeWidth="2"
                    />
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <input
                          {...field}
                          type="number"
                          className={`w-full p-2 rounded border transition-all duration-300 ${themeClasses.input} ${errors.height ? 'border-red-500 shake' : ''}`}
                        />
                      )}
                    />
                    {errors.height && (
                      <p className="text-red-500 text-xs mt-1">
                        {VALIDATION_MESSAGES.height[errors.height.type]}
                      </p>
                    )}
                  </div>
